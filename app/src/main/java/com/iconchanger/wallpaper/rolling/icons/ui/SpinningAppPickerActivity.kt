    ...
    private fun openLiveWallpaperPreview() {
        ...
        val intent = Intent(android.app.WallpaperManager.ACTION_CHANGE_LIVE_WALLPAPER).apply {
            putExtra(
                ...
                android.content.ComponentName(this@SpinningAppPickerActivity, com.iconchanger.wallpaper.rolling.icons.wallpaper.RollingWallpaperService::class.java)
            )
        }
        try {
