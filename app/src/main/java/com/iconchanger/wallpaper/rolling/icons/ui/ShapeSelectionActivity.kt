...
class ShapeSelectionActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.txtHeaderTitle)?.setText(R.string.shape_path_title)
    ...
    private inner class EmojiAdapter : RecyclerView.Adapter<EmojiAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if (isBound) {
                ...
                holder.imgLinkBadge.setColorFilter(ContextCompat.getColor(this@ShapeSelectionActivity, R.color.cosmic_accent))
            } else {
            ...
            val openBindDialog = {
                val dialog = BindAppDialog(this@ShapeSelectionActivity, resId, boundPackage) { newPackage ->
                    scope.launch {
