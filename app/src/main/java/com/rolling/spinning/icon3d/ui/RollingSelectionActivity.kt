...
class RollingSelectionActivity : BaseActivity() {
    ...
    // Photo picker launcher (hỗ trợ chọn nhiều ảnh cùng lúc)
    ...
    private fun selectEmojiTab(group: Int) {
        val activeBg = androidx.core.content.ContextCompat.getDrawable(this, R.drawable.bg_vintage_button_secondary)
        val inactiveBg = null
    ...
    private inner class PhotoAdapter : RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            if (position == 0) {
                ...
                // Hide edit button for simplicity
